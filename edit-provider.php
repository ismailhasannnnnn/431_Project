...
<div class="container main-card">
    ...
    <h1 class="dash"> Provider Profile </h1>
    ...
    <?php if (isset($provider)): ?>
        ...
        <form method="post">
            <input type="submit" name="editProvider" value="Edit Provider"/>
        </form>


    <?php else: ?>
        <p>Looks like you haven't set up your provider profile yet. <a href="new-provider-view.php">Set up provider.</a></p>
    <?php endif; ?>
...
if(isset($_POST['editProvider'])) {
    ...
    echo '<h1 class="dash"> Edit Provider </h1>';
    echo '</div>';
    echo '<div class="one-half column">';
    echo '';
    ...
    echo '';
    echo '';
    echo '    <form action="edit-provider-form.php" method="post" novalidate>';
    echo '';
    echo '';
    echo '        <label for="practiceName">Provider Name  </label>';
    ...
    echo '                value="' . htmlspecialchars($provider["streetAddress"]) . '"></input>';
    echo '';
    echo '            </div>';
    echo '            <div>';
    ...
    echo '                       value="' . htmlspecialchars($provider["zipcode"]) . '">';
    echo '            </div>';
    echo '            <div>';
    echo '                <label for="city">City</label>';
    echo '                <input required type="text" id="city" name="city" autocomplete="address-level2" enterkeyhint="next" value="' . htmlspecialchars($provider["city"]) . '">';
    echo '            </div>';
    echo '            <div>';
